<div class="flex">
    ...
    <div class="flex-1 border ml-5 rounded-lg px-2 py-4 sm:px-6 sm:py-4 leading-relaxed">
        <a href="users/{{$child_comment->comment_owner->id}}" ><strong>{{ $child_comment->comment_owner->name }}</strong></a> <span class="text-xs text-gray-400">{{ $child_comment->created_at }}</span>
